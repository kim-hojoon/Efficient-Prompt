...
def setup_dataloader(args):
    ...
    if args.dataset.startswith('HMDB'):
        ...
        val_dataset = readFeatureHMDB51(root=feature_root, frames=args.numFrames, fpsR=[1, 1/2, 1/3, 1/3, 1/3, 1/4], ensemble=args.valEnsemble, mode='val', sampling_fps=args.inference_fps, fixed_fps=args.fixed_fps)
    # More datasets to be continued
